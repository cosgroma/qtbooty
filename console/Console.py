...
from pyqtgraph import exceptionHandling as exceptionHandling
import pickle
...
class ConsoleWidget(QtGui.QWidget):
  ...
  def runCmd(self, cmd):
    ...
    try:
      ...
      if self.multiline is not None:
        ...
        self.write("<br><div style='background-color: #2A2A2A'><b>%s</b>\n" % encCmd, html=True)
        self.inCmd = True
        self.execSingle(cmd)
  ...
  def write(self, strn, html=False):
    ...
    if html:
      ...
      if self.inCmd:
        self.inCmd = False
        self.output.textCursor().insertHtml("</div><br><div style='font-weight: normal; background-color: #323232; color: #b1b1b1'>")
